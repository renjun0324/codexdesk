...
contextBridge.exposeInMainWorld("codexDesk", {
  ...
  pinSession: (id, filePath, pinned) => ipcRenderer.invoke("sessions:pin", id, filePath, pinned),
  archiveSession: (id, filePath, archived) => ipcRenderer.invoke("sessions:archive", id, filePath, archived),
